  ...
  return (
      <div className="features" id='features'>
          ...
          <div className='main-feature'>
              ...
              <p>Orto Parisi Teroni perfumes blend rare and precious ingredients into a complex, long-lasting fragrance that evolves beautifully, offering an exclusive and sophisticated experience.</p>
          </div>
